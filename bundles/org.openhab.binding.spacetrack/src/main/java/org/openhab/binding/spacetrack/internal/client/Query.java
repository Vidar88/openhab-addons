...
import org.openhab.binding.spacetrack.internal.client.credential.CredentialProvider;
import org.openhab.binding.spacetrack.internal.client.predicate.Predicate;
import org.openhab.binding.spacetrack.internal.client.query.Limit;
import org.openhab.binding.spacetrack.internal.client.query.QueryField;
import org.openhab.binding.spacetrack.internal.client.query.Sort;
...
/**
 * Base class for querying from <a href="https://www.space-track.org/">Space-Track.org</a>. The class follows the
 * builder pattern: the query is constructed using methods like
...
public abstract class Query<T extends QueryField, R, Q extends Query<T, R, Q>> {
    ...
    static {
        ...
        jsonMapper = new ObjectMapper().registerModule(new Jdk8Module()).registerModule(new JavaTimeModule())
    ...
    /**
     * Adds a sorting field to the query. The order of the sorting fields does matter. They will be added to the query
     * in the order of the calls to this method and {@link #addSorts(List)}.
     * 
    ...
    /**
     * Adds a collection of sorting fields to the query. The order of the sorting fields does matter. They will be added
     * to the query in the order of the calls to this method and {@link #addSort(Sort)}.
     * 
    ...
    /**
     * Gets the <a href="https://www.space-track.org/">Space-Track.org</a> URL that represents this query. This URL is
     * the same as what will be generated by invoking {@link #execute()}.
     * 
     * <p>
     * <strong>Note:</strong> This method does not need to be called prior to calling {@link #execute()}. That method
     * will automatically generate the URL as necessary.
     * </p>
     * 
    ...
    /**
     * Executes the query against the <a href="https://www.space-track.org/">Space-Track.org</a> API and returns the
     * results
     * 
    ...
    public List<R> execute() throws JsonParseException, JsonMappingException, IOException {
        ...
        try {
            ...
            logger.debug("Querying SpaceTrack (user: {}, query: {})", userName, queryString);
            ...
            String request = "identity=" + userName + "&password=" + credentials.getPassword() + "&query="
                    + queryString;
            ...
            if (connection.getResponseCode() != HttpsURLConnection.HTTP_OK) {
                throw new IOException(
                        "SpaceTrack returned an unsuccessful response: " + connection.getResponseMessage());
            }
            ...
            logger.debug("SpaceTrack returned {} {} results", results.size(), queryClass);
