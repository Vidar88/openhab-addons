...
/**
 * Class for querying two-line element sets (TLEs) from <a href="https://www.space-track.org/">Space-Track.org</a>. The
 ...
 */
public class TleQuery extends Query<TleQuery.TleQueryField, TleQuery.Tle, TleQuery> {
    ...
    /**
     * Class representing results returned from "TLE" queries on
