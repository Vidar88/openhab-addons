...
import static org.openhab.binding.spacetrack.internal.SpacetrackBindingConstants.CHANNEL_NORAD_ID;
import static org.openhab.binding.spacetrack.internal.SpacetrackBindingConstants.SUPPORTED_DEVICE_THING_TYPES;
...
public class SpacetrackSatelliteHandler extends BaseThingHandler {
    ...
    public void handleCommand(ChannelUID channelUID, Command command) {
        if (CHANNEL_NORAD_ID.equals(channelUID.getId())) {
    ...
    public void initialize() {
        ...
        config = getConfigAs(SpacetrackBridgeConfiguration.class);
