...
/**
 * A {@link Predicate} that filters results based on whether or not the given field is within the given range of values
 * (inclusive)
 * 
...
public class InclusiveRange<T extends QueryField> implements Predicate<T> {
     ...
     * {@link #InclusiveRange(QueryField, UtcInstant, UtcInstant)} or
     * {@link #InclusiveRange(QueryField, TaiInstant, TaiInstant)} if
     * possible.
     * </p>
     */
     ...
     * <p>
     * <strong>Note:</strong> The conversion from UTC-SLS to UTC will not be completely accurate near a leap second. Use
     * {@link #InclusiveRange(QueryField, CurrentDateTimeOffset, UtcInstant)} or
     ...
     * <p>
     * <strong>Note:</strong> The conversion from UTC-SLS to UTC will not be completely accurate near a leap second. Use
     * {@link #InclusiveRange(QueryField, UtcInstant, CurrentDateTimeOffset)} or
    ...
    public InclusiveRange(@NonNull T field, @NonNull CurrentDateTimeOffset lowerValue,
            @NonNull CurrentDateTimeOffset upperValue) {
